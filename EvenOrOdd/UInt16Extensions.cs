...
/// <summary>
/// This class contains some extension methods for <see cref="UInt16"/>.
/// </summary>
public static class UInt16Extensions
{
    ...
    /// </remarks>
    /// <param name="value">
    /// The <see cref="UInt16"/> value to determine if is even or not.
    /// </param>
    /// <returns>
    ...
    /// </remarks>
    /// <param name="value">
    /// The <see cref="UInt16"/> value to determine if is odd or not.
    /// </param>
    /// <returns>
