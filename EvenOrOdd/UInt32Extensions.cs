...
/// <summary>
/// This class contains some extension methods for <see cref="UInt32"/>.
/// </summary>
public static class UInt32Extensions
{
    ...
    /// </remarks>
    /// <param name="value">
    /// The <see cref="UInt32"/> value to determine if is even or not.
    /// </param>
    /// <returns>
    ...
    /// </remarks>
    /// <param name="value">
    /// The <see cref="UInt32"/> value to determine if is odd or not.
    /// </param>
    /// <returns>
