...
/// <summary>
/// This class contains some extension methods for <see cref="Int128"/>.
/// </summary>
public static class Int128Extensions
{
    ...
    /// </remarks>
    /// <param name="value">
    /// The <see cref="Int128"/> value to determine if is even or not.
    /// </param>
    /// <returns>
    ...
    /// </remarks>
    /// <param name="value">
    /// The <see cref="Int128"/> value to determine if is odd or not.
    /// </param>
    /// <returns>
